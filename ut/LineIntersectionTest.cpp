...
//	}
//	BOOST_CHECK_EQUAL(overlapLine->start.x, 3);
//	BOOST_CHECK_EQUAL(overlapLine->start.y, 4);
//	BOOST_CHECK_EQUAL(overlapLine->end.x, 4);
//	BOOST_CHECK_EQUAL(overlapLine->end.y, 6);
//}
//
